...
ARTIFACT_ID="kotlin-http-client-atlas-test"
...
mvn archetype:generate -B -U \
    ...
    "-DartifactId=kotlin-http-client-atlas-test" \
    "-Dpackage=com.linkedplanet.plugin.confluence.insightwrapper.test" \
    "-DnameHumanReadable=kotlin-http-client-atlas-test" \
